...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "rogueTRETASZUMBIS", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "rogueTRETASZUMBIS";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "rogueTRETASZUMBIS", null, { width: 640, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "78",
			company: "HaxeFlixel",
			file: "rogueTRETASZUMBIS",
			fps: 60,
			name: "rogueTRETASZUMBIS",
